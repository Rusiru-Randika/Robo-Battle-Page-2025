...
export default function Timeline() {
  return (
    <div className="pt-10 md:pt-20 relative min-h-screen bg-[#020230]">
      ...
      <div className="relative flex flex-col items-center mt-10 px-10 h-auto">
        {/* Vertical Line */}
        <div className="absolute top-0 bottom-0 left-1/2 transform -translate-x-1/2 w-1 z-0">
          <div className="h-full bg-white w-[4px]" />
        </div>

        {/* === Row 1 === */}
        <div className="flex flex-row justify-between items-center w-full z-10 mb-20">
          {/* Date - Left */}
          <div className="w-1/3 flex justify-end">
            <p className="font-transrobotics px-5 md:px-10 text-center md:text-start text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-400">
              2024 June 12
            </p>
          </div>
        ...
        <div className="flex flex-row justify-between items-center w-full z-10">
          ...
          <div className="w-1/3 flex justify-end">
            <div className="bg-gradient-to-b from-[#0D1B2A] to-[#1B263B] text-white rounded-lg p-3.5 md:p-6 max-w-md shadow-lg">
              ...
              <button className="bg-green-500 font-poppins font-bold text-white text-sm px-3 py-2 rounded hover:bg-green-600 transition">
                Learn More
              </button>
            </div>
          </div>
