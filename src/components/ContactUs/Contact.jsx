...
const TeamCard = ({ member, className, index }) => (
  ...
  >
    {/* background */}
    <div className="w-20 h-60 z-10 bg-gradient-to-b from-[#D9D9D9] via-[#62B8EE] to-[#009DFF] rounded-[48px_0px]"></div>
    {/* details */}
    ...
    <img src={`${fileLocation}${member.photo}`} alt={member.name} className="absolute w-60 z-20" />
  </div>
);
